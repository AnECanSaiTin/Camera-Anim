...
public class InterpolationSettingScreen extends Screen {
    ...
    private void addLine(VertexConsumer buffer, PoseStack.Pose pose, Vector2f pos1, Vector2f pos2, int color) {
        ...
        buffer.vertex(matrix4f, pos1.x, pos1.y, 0).color(color).normal(normal, normalize.x, normalize.y, 0).endVertex();
        buffer.vertex(matrix4f, pos2.x, pos2.y, 0).color(color).normal(normal, normalize.x, normalize.y, 0).endVertex();
    }
    ...
    private static final class Bezier extends AbstractWidget {
        ...
        protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
            ...
            buffer.vertex(matrix4f, point.x * 80 + zeroX + 2, point.y * -80 + zeroY + 2, 0).color(0xFFc4c4c4).endVertex();
            buffer.vertex(matrix4f, point.x * 80 + zeroX + 2, point.y * -80 + zeroY - 2, 0).color(0xFFc4c4c4).endVertex();
            buffer.vertex(matrix4f, point.x * 80 + zeroX - 2, point.y * -80 + zeroY - 2, 0).color(0xFFc4c4c4).endVertex();
            buffer.vertex(matrix4f, point.x * 80 + zeroX - 2, point.y * -80 + zeroY + 2, 0).color(0xFFc4c4c4).endVertex();
        }
